...
**3. Merge**  
Transcript chunks and OCR results are combined into a single unified text corpus, preserving context from both sources.
...
| `pytesseract` + `Pillow` | OCR on extracted frames |
| (your vector store) | Embedding and retrieval |
